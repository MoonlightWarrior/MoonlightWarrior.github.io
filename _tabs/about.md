...
- 뭐든지 들여다보는 걸 좋아합니다. 우선은 컴퓨터과학에서 다양한 분야를 접해보고 있는데(recent. AI theoretical analysis) 이를 통해 전산에 대한 전반적 지식을 익히고, 차차 관심분야가 좁혀지면 그쪽으로 돌진해볼 계획입니다. 일단 현재 관심분야는 XAI, NLP, AI Theory, Optimization 쪽인 것 같긴 합니다. 
...
- 위에 껄 보면 알겠지만 사실 아직은 하는 게임이 원신/붕스 정도입니다. 더 재밌는 게 나오면 할 수도 있긴 한데, 스토리와 음악에 목매는 사람이라..딴겜으로 옮겨갈 가능성이 너무 적음. 이였는데 이환은 해 볼 것 같습니다. 
...
> 박스를 마우스로 올리거나(데스크톱) 탭하면(모바일) 과목명이 보입니다.
{: .prompt-tip }

## Junior + Senior

2027년경 공군이나 카투사로 군 복무를 다녀올 계획이라, 그 이후의 학기는 추후 이어서 업데이트할 예정입니다.
...
<div class="cv-timeline">
  ...
  <div class="cv-tl-item">
    ...
    <div class="cv-award">
      <i class="fas fa-trophy"></i>
      <span class="cv-award-name">2026 UCPC 예선</span>
      <span class="cv-award-result">15th place</span>
    </div>
    <div class="cv-award cv-award-ongoing">
      <i class="fas fa-hourglass-half"></i>
      <span class="cv-award-name">진행 중 — 목표: UCPC 본선, ICPC 등</span>
    </div>
  </div>
</div>
