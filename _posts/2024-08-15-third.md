...
<ul>
    ...
    <li>$\sum\limits_{x \in X} \vert G_{x} \vert = \sum\limits_{x \in X} \frac{\vert G \vert}{\vert G(x) \vert} = \vert G \vert \sum\limits_{x \in X} \frac{1}{\vert G(x) \vert} = \vert G \vert \sum\limits_{A \in X/G} \sum\limits_{x \in A} \frac{1}{\vert A \vert} = \vert G \vert \sum\limits_{A \in X/G} 1 = \vert G \vert \vert X/G \vert$
        <ul>
